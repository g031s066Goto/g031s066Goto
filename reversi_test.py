...
Original file is located at
    https://colab.research.google.com/drive/1zR9vrgtrM9S7qaCzuUC7wIl6VytbOS0O
"""
...
# Constants
#プレイするボードの各ますの大きさ
GridSize = 80 # size in pixels of each square on playing board
#各遊ぶ石のピクセル中のサイズ
...
class Board:
    ...
    def __init__(self, strategies=()): # 初期化 Boardのコンストラクタ 
        ...
        xlabel = "  ____a___            _____b___         _______c___      _______d___        _______e___         _______f___        _______g___          ______h__"
        self._canvas.itemconfig(canvas_id, text=xlabel)  
        y1=1
    ...
    def getNextMove(self, player, moves):
        ...
        if bestMove==None:
            ...
            while len(moves)>1 and trial <=10:
                ...
                x,y,bs=bestMove
                trial +=1
                if (x==1 and y==1) or (x==1 and y==6) or (x==6 and y==1) or (x==6 and y==1) :
                    pass
                elif trial > 10:
                    break
                else:
...
if __name__ == '__main__':
    ...
    strategies = (Random(),Greedy(),CornerFirst(),CornerFirstGreedy())
